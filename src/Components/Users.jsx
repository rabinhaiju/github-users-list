...
const Users = () => {
  ...
  return (
    <div className='bg-blue-300 '>
      <div className='container mx-auto'>
        <div className='py-10'>
          ...
          <div className='flex justify-center my-7'>
            <input value={search} onChange={handleSearch}className='py-2 w-[500px] border border-black' type="text" />
      ...
      <button  onClick ={clearUsers}className='p-3 bg-orange-400 ml-[1000px] '>CLear ALL</button>
      </div>
    </div>
  );
};
